import svgPaths from "./svg-nkrti2z72t";
...
import { imgAiBody, imgColorLayer } from "./svg-68vlz";
...
function Container9() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <Container7 />
      <div className="font-['Figtree:Regular',sans-serif] font-normal leading-[1.6] min-w-full relative shrink-0 text-[#323338] text-[14px] w-[min-content]">

import svgPaths from "./svg-lr3q61hc90";
...
import { imgAiBody, imgColorLayer } from "./svg-oeom4";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon / Platform / Thumbs up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_68_14832)" id="Icon / Platform / Thumbs up">
          <path clipRule="evenodd" d={svgPaths.p28b17900} fill="var(--fill-0, #323338)" fillRule="evenodd" id="Union" />
        </g>
        <defs>
          <clipPath id="clip0_68_14832">
...
function Container4() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Container">
      <Container2 />
      <Content2 />
      <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[#323338] text-[14px] w-[min-content]">Would you like to customize any time slots or session topics further?</p>
      <Container3 />
    </div>
  );
}
...
function AiBody() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[602px] items-start justify-end left-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_16px] mask-size-[400px_586px] overflow-clip pb-[16px] pt-[32px] px-[24px] top-[68px] w-[400px]" data-name="AI body" style={{ maskImage: `url('${imgAiBody}')` }}>
      <Container1 />
      <Container5 />
    </div>
  );
...
function Content3() {
  return (
    <div className="absolute contents left-0 top-[68px]" data-name="Content">
      <AiBody />
    </div>
  );
}
...
function ContentMask() {
  return (
    <div className="absolute h-[670px] left-0 top-0 w-[400px]" data-name="Content + mask">
      <Content3 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Figtree:Regular',sans-serif] font-normal justify-center leading-[0] overflow-ellipsis overflow-hidden relative shrink-0 text-[#323338] text-[14px] text-nowrap">
        <p className="leading-[1.5] overflow-ellipsis overflow-hidden" dir="auto">
          Develop a detailed agenda outline with time slots and session topics, referencing the “Create agenda” task. Ensure logical flow and highlight key segments for the event.
        </p>
      </div>
      <TextCursor />
...
function IconBasicMoveArrowUp() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon / Basic / Move Arrow Up">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_68_14826)" id="Icon / Basic / Move Arrow Up">
          <path clipRule="evenodd" d={svgPaths.p1a3c500} fill="var(--fill-0, white)" fillRule="evenodd" id="Union" />
        </g>
        <defs>
          <clipPath id="clip0_68_14826">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function SubmitButton() {
  return (
    <div className="bg-[#0073ea] content-stretch flex gap-[8px] items-center justify-center max-h-[24px] max-w-[24px] relative rounded-[12px] shrink-0 size-[24px]" data-name="Submit button">
...
function Container9() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Container">
      ...
      <div aria-hidden="true" className="absolute border border-[#323338] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_0px_8px_0px_rgba(174,212,252,0.4)]" />
    </div>
  );
}

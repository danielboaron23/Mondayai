import svgPaths from "./svg-wc6ymhm8u9";
...
import { imgAiBody, imgColorLayer } from "./svg-tu0e3";
...
function Content3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="content">
      <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[1.5] max-w-[270px] relative shrink-0 text-[#323338] text-[14px] text-nowrap" dir="auto">
        Add the agenda as an update to the task
      </p>
    </div>
  );
}
...
function IconColoredAiColored1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon / Colored / AI Colored">
      <div className="absolute inset-[7.5%]" data-name="Star">
        <img alt="" className="block max-w-none size-full" height="17" src={imgStar} width="17" />
...
function Variant() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Variant">
      <IconColoredAiColored1 />
      <p className="bg-clip-text bg-gradient-to-r font-['Figtree:Regular',sans-serif] font-normal from-[#555761] from-[5.769%] leading-[20px] relative shrink-0 text-[14px] text-nowrap to-[#caccd6] to-[87.5%] via-[#323338] via-[41.346%]" dir="auto" style={{ WebkitTextFillColor: "transparent" }}>
        Thinking...
      </p>
    </div>
  );
...
function Container8() {
  return (
    <div className="h-[452px] relative shrink-0 w-full" data-name="Container">
      <div className="size-full">
        <div className="content-stretch flex items-start pl-0 pr-[16px] py-0 relative size-full">
          <Container7 />
        </div>
      </div>
    </div>
...
function IconPlatformStopAi() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon / Platform / Stop AI">
      <div className="absolute inset-[0_-6.25%_-6.25%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
          <g id="Icon / Platform / Stop AI">
            <path d={svgPaths.p2b4f4300} fill="var(--fill-0, white)" id="Union" />
          </g>
        </svg>
      </div>
    </div>
